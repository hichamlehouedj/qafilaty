...
const MoneyDriverPickUpCard = ({code_invoice, dataInvoice, idDriver}: DeliveryCardProps) => {
    ...
    useEffect(() => {
        ...
        dataInvoice?.map((box: any, index: number) => {
    ...
    return (
        <StyledDeliveryCard>
                        ...
                        <Grid container justifyContent={"space-between"}>
                            <Grid item>
                                <Stack direction={"row"} columnGap={"10px"} alignItems="center">
                                    <Divider orientation="vertical" variant="fullWidth" flexItem style={{borderColor: deepPurple[500], borderWidth: "2px", borderRadius: "3px"}} />
            ...
            <Menu {...bindMenu(popupState)}>
                <Link href={{pathname: "/invoiceDriverPickUp", query: {id: idDriver, codeInvoice: code_invoice as any}}} passHref>
                    <a target="_blank">
                        <MenuItem>
...
export default MoneyDriverPickUpCard;
