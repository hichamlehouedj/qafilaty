...
const ExtractAllPDF = ({ shipmentDataList, userData }: Props) => {
    ...
    useEffect(() => {
        if (userData != undefined) {
            setCompany({
                name: userData?.person?.company?.name,
                city: userData?.person?.company?.city,
                address: userData?.person?.company?.address,
                phone01: userData?.person?.company?.phone01,
                email: userData?.person?.company?.email
            })
        }
    }, [userData])
                                    ...
                                    <View style={{display: "flex",}}>
                                        <View style={{ display: "flex" }}>
                                            <View style={{display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end",}}>
                                                ...
                                                <Text style={{ fontSize: 23, color: "#575757" }}>طرود</Text>
                                            </View>
                            ...
                            <View>
                                        ...
                                        <View style={{justifyContent: "flex-end", flexDirection: "column-reverse", flexBasis: "49.5%"}}>
                                            <View style={{flexDirection: "row", justifyContent: "flex-end", margin: -4,}}>
                                                <Text style={{fontSize: 11, color: "#707070", margin: 4, textAlign: "left",}}>
                                                    {`${algerian_provinces?.[company.city - 1]?.wilaya_name}, ${company.address}`}
                                                </Text>
                                                <Text style={{fontSize: 11, color: "#909090", margin: 4,}}>العنوان الكامل:</Text>
                                            </View>
                                            ...
                                            <View style={{flexDirection: "row", justifyContent: "flex-end", margin: -4, paddingBottom: 8,}}>
                                                ...
                                                <Text style={{fontSize: 11, color: "#909090", margin: 4,}}>إسم الشركة:</Text>
                                            </View>
                                        </View>
                                        <View style={{justifyContent: "flex-end", flexDirection: "column-reverse", flexBasis: "49.5%",}}>
                                            <View style={{flexDirection: "row", justifyContent: "flex-end", margin: -4,}}>
                                                <Text style={{fontSize: 11, color: "#707070", margin: 4,}}>{company?.phone01}</Text>
                                                <Text style={{fontSize: 11, color: "#909090", margin: 4,}}>رقم الهاتف:</Text>
                                            </View>

                                            <View style={{flexDirection: "row", justifyContent: "flex-end", margin: -4, paddingBottom: 8,}}>
                                                <Text style={{fontSize: 11, color: "#707070", margin: 4,}}>{company?.email}</Text>
                                ...
                                <View style={{border: `0.5 solid ${grey[300]}`, marginTop: "32px",}}>
                                    ...
                                    <View style={{display: "flex", flexDirection: "row",}}>
                                        ...
                                        >
                                            <Text style={{color: "#9E9E9E", fontSize: 9,}}>إسم المرسل</Text>
                                        </View>

                                        <View
                                            style={{
                                                flex: "0.8", flexShrink: 0, backgroundColor: alpha(theme.palette.primary.main, 0.1),
                                        ...
                                        <View
                                            style={{
                                                flex: "0.2", flexShrink: 0, backgroundColor: alpha(theme.palette.primary.main, 0.1),
                                                height: "32px", justifyContent: "center", alignItems: "center", padding: 6,
                                                border: `0.5 solid ${grey[300]}`,
                                            }}
                                        >
                                        ...
                                        <View key={index} style={{display: "flex", flexDirection: "row",}}>
                                            ...
                                            >
                                                <Text style={{color: "#707070", fontSize: 9,}}>
                                                    ...
                                                    {shipment?.paid_in_office ? 0 : shipment?.price_delivery}
                                                </Text>
                                            </View>
                                            ...
                                            <View
                                                style={{
                                                    flex: "0.8", flexShrink: 0, height: "32px", justifyContent: "center", alignItems: "flex-end",
                                                    border: `0.5 solid ${grey[300]}`, padding: 6,
                                                }}
                                            >
                                            ...
                                            <View
                                                style={{
                                                    flex: "0.2", flexShrink: 0, height: "32px", justifyContent: "center", alignItems: "center",
                                                    border: `0.5 solid ${grey[300]}`, padding: 6,
                                                }}
                                            >
