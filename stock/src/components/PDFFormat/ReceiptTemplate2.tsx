                            ...
                            <View>
                                ...
                                <View>
                                    <View style={{display: "flex", flexDirection: "row", marginTop: "32px", width: "50%", marginLeft: "auto",}}>
                                        ...
                                        >
                                            <Text style={{color: grey[500], fontSize: 10,}}>م. سعر الطرد</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{display: "flex", flexDirection: "row", width: "50%", marginLeft: "auto",}}>
                                        ...
                                        >
                                            <Text style={{color: "#707070", fontSize: 10,}}>
                                                <Text style={{ fontSize: 8 }}>د.ج</Text>
                                                {shipmentDataList?.reduce((prev: any, shipment: any) => prev + shipment.price_delivery, 0)}
                                            </Text>
                                        </View>
                                    ...
                                    <View style={{display: "flex", flexDirection: "row", width: "50%", marginLeft: "auto",}}>
                                        ...
                                        >
                                            <Text style={{color: "#FFF", fontSize: 10,}}>المبلغ المستحق</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
