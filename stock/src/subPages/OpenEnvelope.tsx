...
import {useGetOpenEnvelopeCity} from "../graphql/hooks/envelopes";
...
export default function OpenEnvelopes({setHasData}: Props): ReactElement {
    ...
    // get all shipments
    let [getEnvelopeCityData, getEnvelopeCityLoading] = useGetOpenEnvelopeCity({
    ...
    // watchers
    useEffect(() => {
        //console.log("getEnvelopeCityData", getEnvelopeCityData)
