...
import {useGetCloseEnvelopeCity} from "../graphql/hooks/envelopes";
...
export default function CloseEnvelopes({setHasData}: Props): ReactElement {
    ...
    // get all shipments
    let [getEnvelopeCityData, getEnvelopeCityLoading] = useGetCloseEnvelopeCity({
