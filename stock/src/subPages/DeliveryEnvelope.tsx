...
import {useGetDeliveryEnvelopeCity} from "../graphql/hooks/envelopes";
...
export default function DeliveryEnvelopes({setHasData}: Props): ReactElement {
    ...
    // get all shipments
    let [getEnvelopeCityData, getEnvelopeCityLoading] = useGetDeliveryEnvelopeCity({
